...
const CartModal = () => {
  ...
  //           className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-sm w-full mx-auto"
  ...
  //                 <div className="w-20 h-20 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden border-2 border-gray-200 dark:border-gray-600">
  //                   <img
  ...
  //               className="w-full text-gray-600 dark:text-gray-400 underline hover:text-gray-800 dark:hover:text-white transition-colors py-2"
  //             >
  //               Continue shopping
  //             </motion.button>
  //           </div>
